    ...
    for (const link of linksData) {
        try {
            ...
            while (hasNextPage) {
                ...
                const nextButton = await page.$('a#itemResults_next');
            ...
            // Save the consolidated HTML content even if an error occurs
            const errorHtmlFilePath = path.join(folderPath, `error_${Date.now()}.html`);
